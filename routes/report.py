...
def compliance_report():
    try:
        ...
        SELECT
            ...
            rc.regcmp_approvers_email         AS approvers_email,
        ...
        regulatory_rows = list(cursor.fetchall() or [])
        ...
        self_rows = list(cursor.fetchall() or [])
        ...
        all_rows.sort(
            key=lambda x: safe_date(x.get("action_date")) or date.max
        )
